...
contract HealthMonitoringSystem {
    ...
    //******************************************************//
     ...
     modifier onlyPatientWrite() {
        require(Patient_Account_IsRegistered[msg.sender] == true);
        _;
    }
    
   // modifier onlyPatientDoctorHospital(){
    ...
    function Get_Sensors(uint8 _Patient_HeartBeat,uint8 _Patient_BloodPressure,uint8 _Patient_Temperature) onlyPatientWrite public{
